...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_cellule" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#bb0cf1e6#;
   pragma Export (C, u00001, "test_celluleB");
   ...
   u00154 : constant Version_32 := 16#b8cfd2bd#;
   pragma Export (C, u00154, "celluleB");
   u00155 : constant Version_32 := 16#4f01e5ee#;
