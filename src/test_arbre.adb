...
procedure Test_Arbre is
   ...
   procedure Tester_Enregistrement_Fils is
      Cellule1 : T_Arbre;
      Cellule2 : T_Arbre;
      Cellule_Mere : T_Arbre;
   begin
      ...
      Enregistrer_FilsGauche(Cellule_Mere,Cellule2);
   end Tester_Enregistrement_Fils;
